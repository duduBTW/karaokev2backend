...
![Build](https://github.com/duduBTW/karaokev2backend/workflows/Go/badge.svg)
...
- **[Github Actions Workflows](https://github.com/duduBTW/karaokev2backend/tree/main/.github/workflows)** - Pre-configured Github Actions to run automated builds and publish image to Github Packages
- **[Dockerfile](https://github.com/duduBTW/karaokev2backend/blob/main/Dockerfile)** - Dockerfile to generate docker builds.
- **[docker-compose](https://github.com/duduBTW/karaokev2backend/blob/main/docker-compose.yml)** - Docker compose script to start service in production mode.
